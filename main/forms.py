...
class UserForm(UserCreationForm):
    ...
    first_name = forms.CharField(max_length=150, required=False) #no requiere que se rellene el campo
    ...
    #queryset conjunto de objetos que proviene de una consulta : ej lista de categorias de preferencias

    # Colaborador attributes
    is_colaborador = forms.BooleanField(required=False)
    reputacion = forms.FloatField(required=False) #lo comentamos pq el usuario no se debe autocalificar
